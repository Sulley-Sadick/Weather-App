      ...
      <div className="mt-6 grid grid-cols-1 gap-7 sm:grid-cols-2 lg:grid-cols-3">
        {weatherHistory.slice(0, 3).map((city) => (
          <div className="flex-center flex-col" key={city.current.id}>
            <button
              className="flex w-full cursor-pointer gap-4 self-start rounded-md bg-gray-300 p-4 shadow-lg transition-transform duration-300 hover:scale-[1.1] dark:bg-gray-800"
